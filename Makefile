# This Makefile is for the String::Palindrome extension to perl.
#
...
#     ABSTRACT => q[Determine if a string is a palindrome]
#     AUTHOR => q[Adam Lesperance <lespea@cpan.org>]
#     DIR => []
#     DISTNAME => q[String-Palindrome]
#     NAME => q[String::Palindrome]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], ExtUtils::MakeMaker=>q[6.42], Carp=>q[0] }
#     SIGN => q[1]
#     VERSION => q[0.01]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/String/Palindrome.pm
...
TO_INST_PM = lib/String/Palindrome.pm

PM_TO_BLIB = lib/String/Palindrome.pm \
...
DISTVNAME = String-Palindrome-0.01
...
manifypods : pure_all  \
	lib/String/Palindrome.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/String/Palindrome.pm $(INST_MAN3DIR)/String::Palindrome.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Determine if a string is a palindrome</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Adam Lesperance &lt;lespea@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/String/Palindrome.pm blib/lib/String/Palindrome.pm 
